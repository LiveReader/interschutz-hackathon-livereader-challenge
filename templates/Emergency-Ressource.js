...
function shapeBuilder(data, TemplateAPI) {
	...
	function setStatus(statusShape) {
		...
		statusShape
			.classed("gly_gray_fill", s == 6 || s == -1)
			.classed("gly_orange_fill", s == 0 || s == 5)
			.classed("gly_green_fill", s == 1 || s == 2 || s == 8)
			.classed("gly_purple_fill", s == 3 || s == 4 || s == 7)
			.classed("lighten", s == 5 || s == 2 || s == 4)
			.classed("lighten", s == 8 || s == 7 || s == 6 || s == -1);
	}
